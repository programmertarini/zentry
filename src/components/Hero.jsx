...
const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      <div
        id="video-frame"
        className="z-10 relative h-dvh w-screen overflow-hidden rounded-lg bg-blue-75"
      >
        <div className="mask-clip-path absolute-center mt-[20vw] md:mt-[0vw] absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
          <div
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-20 px-2 sm:mx-10">
